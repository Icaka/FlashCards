...
class MainApp(tk.Tk):  # extends tk.Tk class
    def __init__(self, user_c: UserController, card_controller: FlashCardController):
        super().__init__()
    ...
    def switch_view(self, frame_class: tk.Frame):
        new_view = frame_class(self, self.switch_view, self.u_controller, self.card_controller)  # also passing the switch_view function
